...
{   
    public class ILRuntimeUIBaseAdapter : CrossBindingAdaptor
    {
        static CrossBindingMethodInfo mOnInit_0 = new CrossBindingMethodInfo("OnInit");
        static CrossBindingMethodInfo<System.Object[]> mBeforeOpen_1 = new CrossBindingMethodInfo<System.Object[]>("BeforeOpen");
        ...
        public override Type BaseCLRType
        {
            get
            {
                return typeof(KSFramework.ILRuntimeUIBase);
            }
        }
        ...
        public class Adapter : KSFramework.ILRuntimeUIBase, CrossBindingAdaptorType
        {
            ...
            public override void BeforeOpen(System.Object[] onOpenArgs)
            {
                if (mBeforeOpen_1.CheckShouldInvokeBase(this.instance))
                    base.BeforeOpen(onOpenArgs);
                else
                    mBeforeOpen_1.Invoke(this.instance, onOpenArgs);
            }
